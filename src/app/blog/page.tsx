...
//   let allBlogs = getBlogPosts().find(
//     (post) =>
//       post.metadata.title === query ||
//       post.metadata.summary === query ||
//       post.metadata.publishedAt === query ||
//       post.metadata.image === query ||
//       post.slug === query ||
//       post.content === query
//   );
//   console.log(query);
...
//         read my blog
//       </h1>
//       <div className="mb-10  max-w-[650px] w-full ">
//         <SearchBox />
//       </div>
